    ...
    >
      ...
      <button
        ...
        style={{
          ...
          boxShadow: "0 1px 2px rgba(20,23,28,.18), 0 6px 16px rgba(214,53,28,.30), inset 0 1px 0 rgba(255,255,255,.25)",
        }}
        onMouseEnter={(e) => {
          e.currentTarget.style.transform = "scale(1.06)";
          e.currentTarget.style.boxShadow = "0 1px 2px rgba(20,23,28,.18), 0 10px 24px rgba(214,53,28,.36), inset 0 1px 0 rgba(255,255,255,.3)";
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.transform = "none";
          e.currentTarget.style.boxShadow = "0 1px 2px rgba(20,23,28,.18), 0 6px 16px rgba(214,53,28,.30), inset 0 1px 0 rgba(255,255,255,.25)";
        }}
      >
