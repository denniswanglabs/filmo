  ...
  return (
    <section className="px-5 py-20 sm:py-24">
      <div className="mx-auto max-w-5xl">
        <div className="overflow-hidden rounded-2xl border border-amber/15 bg-amber/5 px-6 py-14 text-center shadow-[0_18px_50px_-20px_rgba(20,23,28,0.25)] sm:px-12 sm:py-16">
